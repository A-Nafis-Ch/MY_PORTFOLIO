    ...
    return (
        <div className='text-white w-full flex justify-between p-10 md: p-20'>
            ...
            <div className='md:w-2/4 md:pt-10'>
                ...
                <h1 className='text-3xl md:text-6xl w-[140px] h-[150px] md:h-[300px] md:w-[280px] font-bold flex leading-normal tracking-tighter'>
                    <Typewriter
                        ...
                        delaySpeed={2000}
                    /></h1>
                <p className='text-sm md:text-2xl tracking-tight'>Full Stack Developer | UI/UX Designer</p>
            ...
            <div>
                ...
                <img className='h-[250px] w-[250px] md:h-[500px] md:w-[500px] lg:h-[700px] lg:w-[700px] rounded-full object-cover' src="/PortfolioPic/portfolio.jpg" alt="Avatar" />
