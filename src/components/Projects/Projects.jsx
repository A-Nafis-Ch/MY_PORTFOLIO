  ...
  return (
    <div id="Projects" className="text-white w-full md:w-3/4 mx-auto p-5 md:p-10">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 place-items-center">
        ...
        <ProjectCard title="Spotify Clone" img="/Spotify Clone/Spotify_Template.jpg" desc="Spotify Clone using html, css and JavaScript." srcCode="https://github.com/A-Nafis-Ch/Spotify__Clone_Website.git" demo="#"  />
